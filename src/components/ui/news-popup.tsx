...
function DrawerDialogDemo({ newsItems }: DrawerDialogDemoProps) {
      ...
      <>
        {newsItems.map((item: NewsItem) => (
          <Dialog key={item.id} open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[700px] sm:max-h-[700px]">
              <DialogHeader>
              ...
              <DialogDescription className="text-left text-black">
                {item.content}
              </DialogDescription>
            </DialogContent>
          </Dialog>
  ...
  return (
    <>
      {newsItems.map((item: NewsItem) => (
<Drawer key={item.id} open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        ...
        <DrawerDescription className="text-left text-black ml-4">
          {item.content}
        </DrawerDescription>
