...
const testimonials = [
  {
    ...
    text: "Jeremy et son équipe ont réalisés notre terrasse, notre palissade et notre jardin. Il a réussi à être à l'écoute de nos envies et nous a apporté de bons conseils. Nous sommes ravis du résultat final !",
    rating: 5,
    location: "Client satisfait"
  },
  {
